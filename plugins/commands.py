...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/sai_bots')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/sai_movies27"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Jion Movies Group', url='https://t.me/sai_movies27')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
